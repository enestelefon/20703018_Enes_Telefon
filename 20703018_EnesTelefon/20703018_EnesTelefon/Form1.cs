...
namespace _20703018_EnesTelefon
{
        ...
        public class AracFirmalari
    {
        ...
        {
             dataGridView1.DataSource = filtrele();
        }

        private void button4_Click(object sender, EventArgs e) //Veri Tabanına kaydetmesini yapar.
        {
            komut = new SqlCommand("INSERT INTO [liste].[dbo].[Table](AracMarkasi, AracUlkesi, AracKm, AracModel) VALUES (@AracMarkasi, @AracUlkesi, @AracKm, @AracModel)", baglanti);
            komut.Parameters.AddWithValue("@AracMarkasi", textBox2);
            komut.Parameters.AddWithValue("@AracUlkesi", textBox3);
            komut.Parameters.AddWithValue("@AracKm", textBox4);
            komut.Parameters.AddWithValue("@AracModel", textBox5);
